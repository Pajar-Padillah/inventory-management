...
<head>
    ...
    <!-- Icon -->
    <link href="<?php echo base_url(); ?>assets/img/kpu-logo.png" rel="icon">

    <!-- title -->
    <title><?= $title; ?> | Aplikasi Inventaris KPU</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex text-white align-items-center bg-white justify-content-center" href="<?= base_url('dashboard'); ?>">
                <div class="sidebar-brand-icon">
                    <img src="<?= base_url('assets/img/kpu-logo.png') ?>" height="40" />
                </div>
                <div class="sidebar-brand-text mx-3" style="color: black;"><b>Inventory KPU</b></div>
            </a>
            ...
            <?php if (is_admin() or is_gudang()) : ?>
                <li class="nav-item">
                    <a class="nav-link pb-0" href="<?= base_url('ruang'); ?>">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-dark bg-gray topbar mb-4 static-top shadow-sm">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline small text-capitalize" style="color: black;">
                                    <?= userdata('nama'); ?>
                                </span>
                    ...
                    <div class="page-breadcrumb mb-4">
                        <div class="row">
                            <div class="col-7 align-self-center">
                                <h3 class="page-title text-truncate text-dark font-weight-medium mb-1"><b><?= $title2; ?></b></h3>
