    ...
    <div class="col-md-12">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo base_url('barangrusak/editbarangrusak'); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-4">
                            <input value="<?= $barang->tanggal_rusak; ?>" name="tanggal_rusak" id="tanggal_rusak" class="form-control date" placeholder="Tanggal Kerusakan...">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-2">
                         <a href="<?= base_url('assets/img/rusak/' . $barang->foto); ?>" id="check_enlarge_photo" class="enlarge">
                           <img style="width: 150px; height: 120px" src="<?= base_url('assets/img/rusak/' . $barang->foto); ?>" class="shadow-sm img-thumbnail"></a>
                       </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-10">
                        <input value="<?= $barang->keterangan_rusak; ?>" name="keterangan_rusak" id="keterangan_rusak" type="text" class="form-control" placeholder="keterangan rusak..."></input>
