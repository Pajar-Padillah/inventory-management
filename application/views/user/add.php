        ...
        <div class="card shadow-sm mb-4 border-bottom-primary">
            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input value="<?= set_value('email'); ?>" type="email" id="email" name="email" class="form-control" placeholder="Email">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="custom-control custom-radio">
                            ...
                            <label class="custom-control-label" for="gudang">Penjaga Gudang</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input <?= set_radio('role', 'umum'); ?> value="umum" type="radio" id="umum" name="role" class="custom-control-input">
                            <label class="custom-control-label" for="umum">Subbag Umum</label>
                        </div>
