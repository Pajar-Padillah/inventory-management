                ...
                if ($users) :
                    foreach ($users as $user) :
                        ...
                        <tr>
                            <td><?= $no++; ?></td>
                            <td>
                                <a href="<?= base_url('assets/img/avatar/') . $user['foto']; ?>" id="check_enlarge_photo" class="enlarge"> <img width="30" src="<?= base_url() ?>assets/img/avatar/<?= $user['foto'] ?>" alt="<?= $user['nama']; ?>" class="img-thumbnail rounded-circle"></a>
                            </td>
                            <td><?= $user['nama']; ?></td>
                            <td><?= $user['username']; ?></td>
                            <td><?= $user['email']; ?></td>
                            ...
                            <td>
                                ...
                                <?php elseif ($user['role'] == 'gudang'): ?>
                                    <span>Penjaga Gudang</span>
                                <?php elseif ($user['role'] == 'umum'): ?>
                                    <span>Subbag Umum</span>
                                <?php endif ?>
                            </td>
                            <td>
