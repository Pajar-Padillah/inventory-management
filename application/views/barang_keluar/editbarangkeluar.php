    ...
    <div class="col-md-12">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo base_url('barangkeluar/editbarangkeluar'); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-2">
                            <a href="<?= base_url('assets/img/keluar/' . $barang->kuitansi); ?>" id="check_enlarge_photo" class="enlarge">
                             <img style="width: 150px; height: 120px" src="<?= base_url('assets/img/keluar/' . $barang->kuitansi); ?>" class="shadow-sm img-thumbnail"></a>
                         </div>
                         <div class="col-8">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-10">
                           <input value="<?= $barang->nilai_lelang; ?>" name="nilai_lelang" id="nilai_lelang" type="number" class="form-control" placeholder="Nilai lelang... ">
